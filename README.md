...
1. `gflow config create-context` initially create a context pointing to your Grafana instance configuration. Each context points to specific grafana instances and tenants. Run `gflow config use-context` to switch between contexts.
